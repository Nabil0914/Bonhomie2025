...
const HamdONaatRegistrationForm = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center font-sans text-sm" style={{ background: 'linear-gradient(90deg, #FF7F41FF, #4a56a3)' }}>
      <div className="bg-white p-6 rounded-lg shadow-lg max-w-lg w-full">
        <h2 className="text-center text-xl font-bold text-orange-500">Hamd-o-Naat Registration Form</h2>
...
export default HamdONaatRegistrationForm;
