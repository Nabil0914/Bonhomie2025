...
const GirlsShotputRegistration = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-orange-500 to-indigo-600">
            <div className="container bg-white p-8 rounded-3xl shadow-lg max-w-lg">
                <h2 className="text-center text-orange-600 font-bold text-2xl mb-6">Girls Shotput Registration Form</h2>
...
export default GirlsShotputRegistration;
