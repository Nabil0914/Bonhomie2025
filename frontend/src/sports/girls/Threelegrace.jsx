...
const GirlsThreeLegRaceRegistration = () => {
        ...
        <div className="flex justify-center items-center min-h-screen bg-gradient-to-r from-orange-500 to-blue-600">
            <div className="bg-white rounded-lg shadow-lg p-8 max-w-xl w-full">
                <h2 className="text-2xl font-bold text-center text-orange-500 mb-4">
                    Three Leg Race Registration Form
                </h2>
                <form onSubmit={handleSubmit}>
                    ...
                    <p className="text-sm text-red-500 mb-4">Note: Only 3 members</p>
...
export default GirlsThreeLegRaceRegistration;
