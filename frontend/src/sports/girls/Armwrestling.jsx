...
const GirlsArmwrestlingRegistration = () => {
        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-orange-500 to-indigo-600">
            <div className="w-full max-w-lg bg-white rounded-lg shadow-lg p-8">
                <h2 className="text-2xl font-bold text-center text-gray-800 mb-6">
                    Armwrestling Registration Form
                </h2>

                {/* Conditionally Render Success or Error Alert */}
                {message && (
                    <div
                        className={`p-4 mb-4 text-sm ${messageType === 'success'
...
export default GirlsArmwrestlingRegistration;
