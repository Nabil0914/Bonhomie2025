...
const GirlsVolleyballRegistration = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-r from-orange-400 to-blue-600 flex items-center justify-center">
            <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-3xl">
                <h2 className="text-2xl font-bold text-center text-orange-600 mb-4">Volleyball Registration Form (Girls)</h2>
...
export default GirlsVolleyballRegistration;
